...
const employees = [
  ...
  /* Su consiglio di Marius, ho eliminato le cartelle JS e IMG perchè
     anche se il codice era corretto, windows mi dava un errore nel
     caricamento dell'SRC delle immagini 
  */
